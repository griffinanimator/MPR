...
TITLE = "Spine"
DESCRIPTION = "Creates an optionaly interpolating joint count adjustable spline.  Ideal use:  Spine."
ICON = os.environ["GEPPETTO"] + "/Icons/spineMod_button.bmp"

class Spine(blueprintMod.Blueprint):

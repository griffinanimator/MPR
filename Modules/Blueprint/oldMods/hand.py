...
TITLE = "Hand"
DESCRIPTION = "Creates a single joint with control for position and orientation. Once created (locked)  the joint can only rotate. Use for the Wrist/Hand"
ICON = os.environ["GEPPETTO"] + "/Icons/handMod_button.bmp"
# 095
class Hand(blueprintMod.Blueprint):
    def __init__(self, userSpecifiedName, hookObject):
        
        # The following allows for install with default functionality
        jointInfo = [ ["hand_1_joint", [0.0, 0.0, 0.0]] ]

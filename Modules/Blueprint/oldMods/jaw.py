...
TITLE = "Jaw"
DESCRIPTION = "Creates 2 joints, with control for 1 joints rotation order and orientation. Suggested use: Jaw"
ICON = os.environ["GEPPETTO"] + "/Icons/singleChain_button.bmp"

class Jaw(blueprintMod.Blueprint):
    def __init__(self, userSpecifiedName, hookObject):
        jointInfo = [["jaw_1_joint", [0.0, 0.0, 0.0]], ["jaw_2_joint", [0.0, 4.0, 0.0]]] 
        
        gameJntNames = ["jaw_1_", "jaw_2_"]

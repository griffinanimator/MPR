...
TITLE = "Head"
DESCRIPTION = "Creates 2 joints, with control for 1 joints rotation order and orientation. Suggested use: Head"
ICON = os.environ["GEPPETTO"] + "/Icons/singleChain_button.bmp"

class Head(blueprintMod.Blueprint):
    def __init__(self, userSpecifiedName, hookObject):
        jointInfo = [["head_1_joint", [0.0, 0.0, 0.0]], ["head_2_joint", [0.0, 4.0, 0.0]]] 
        
        gameJntNames = ["head_1_", "head_2_"]
